...
#saver.restore(sess,"My_first_model" )

summ = tf.summary.merge_all()
for _ in range(1000):
    sess.run(train_step,feed_dict={X:private_test_x, Y:y_private,keep_prob: 0.5}) 
    if _%10==0:
...
save_path = saver.save(sess, "graphTrain/My_first_model")
