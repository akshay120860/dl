...
def conv2d(x,size_in,size_out,name="conv2d"):
    with tf.name_scope(name):
       ...
       # conv2 = tf.nn.conv2d(activation1, w, strides=[1, 1, 1, 1], padding="SAME")
       # activation2 = tf.nn.relu(conv2 + b)
...
y_ = fullyConnected(h_fc1,512,7,name="fc2")
...
print(sess.run(accuracy,feed_dict={X:public_test_x,Y:public_test_y}))
