...
def conv2d(x,size_in,size_out,name="conv2d"):
    ...
    return tf.nn.max_pool(activation2, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")
...
h_pool1_drop = tf.nn.dropout(h_pool1, conv_drop)
h_pool2 = conv2d(h_pool1_drop,32,64,"conv2")
...
writer = tf.summary.FileWriter("Emo_DropOut")
